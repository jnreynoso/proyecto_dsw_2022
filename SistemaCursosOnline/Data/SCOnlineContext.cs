...
namespace SistemaCursosOnline.Data
{
    public class SCOnlineContext : DbContext
    {
        ...
        public DbSet<SistemaCursosOnline.Models.TeacherCourse>? TeacherCourse{ get; set; }
        public DbSet<SistemaCursosOnline.Models.TeacherScheduling>? TeacherScheduling { get; set; }
        public DbSet<SistemaCursosOnline.Models.TbUser>? TbUser { get; set; }
        public DbSet<SistemaCursosOnline.Models.Alumn>? Alumn { get; set; }
    }
}
